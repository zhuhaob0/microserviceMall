...
const (
	UserService_Check_FullMethodName      = "/pb.UserService/Check"
	UserService_AdminCheck_FullMethodName = "/pb.UserService/AdminCheck"
...
type UserServiceClient interface {
	...
	AdminCheck(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserResponse, error)
...
func (c *userServiceClient) AdminCheck(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserResponse, error) {
	out := new(UserResponse)
	err := c.cc.Invoke(ctx, UserService_AdminCheck_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	...
	AdminCheck(context.Context, *UserRequest) (*UserResponse, error)
...
func (UnimplementedUserServiceServer) AdminCheck(context.Context, *UserRequest) (*UserResponse, error) {
...
func _UserService_AdminCheck_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).AdminCheck(ctx, req.(*UserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
