...
import (
	...
	"final-design/sk-core/service/srv_product"
...
var SecLayerCtx = &SecLayerContext{
	...
	WriteOrder2RedisChan: make(chan *Order, 1024),
...
type SecResult struct {
	...
	TokenTime int64  `json:"token_time"` // Token 生成时间
	Code      int    `json:"code"`       // 状态码
}

type SecRequest struct {
	ProductId     int             `json:"product_id"`     // 商品
...
type SecLayerContext struct {
	...
	WriteOrder2RedisChan chan *Order
