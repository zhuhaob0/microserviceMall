...
var (
	ErrInvalidClientRequest = errors.New("invalid clent message")
...
// Make endpoint
func MakeTokenEndpoint(svc service.TokenGranter, clientSever service.ClientDetailsService) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (response interface{}, err error) {
...
func MakeCheckTokenEndpoint(svc service.TokenService) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (response interface{}, err error) {
		...
		var errString = ""
		if err != nil { // token过期 或者 解析错误 都会使err!=nil
			errString = err.Error()
		}
